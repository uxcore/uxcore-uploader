...
ReactDOM.render((
    <Uploader autoPending={false} multiple={false} tips={tips} name='file' url='http://eternalsky.me:8122/file/upload' locale="en" />
), document.getElementById('sample1'));

ReactDOM.render((
    <Uploader autoPending={true} multiple={false}  name='file' url='http://eternalsky.me:8122/file/upload' />
...
ReactDOM.render((
    <Uploader autoPending={false} multiple={true} name='file' url='http://eternalsky.me:8122/file/upload' />
), document.getElementById('sample4'));

ReactDOM.render((
    <Uploader.Dropzoom autoPending={false} multiple={true} queueCapcity={20} name='file' url='http://eternalsky.me:8122/file/upload' />
